    ...
    return (
        <div className="pt-[120px]">
            <div className="absolute top-0 left-0 -z-50 flex flex-col items-center justify-between h-[80vh] w-full ">
                <Image className="mask-image object-cover object-center w-full h-full" width={1800} height={1350} src="/images/photo-1569169092896-7bdc87667f02.jpg" alt="Placeholder" priority />
            </div>
